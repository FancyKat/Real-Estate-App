...
READ_DOT_ENV_FILE = env.bool("DJANGO_READ_DOT_ENV_FILE", default=True)  # Changed to True for Local Development
...
SPECTACULAR_SETTINGS = {
    ...
    "SERVERS": [
        ...
        {"url": "https://quiet-mesa-73046.herokuapp.com", "description": "Production server"},
    ],
}
# Your stuff...
# ------------------------------------------------------------------------------
